import { AngularGBooksPage } from './../../../e2e/app.po';
import { Injectable, EventEmitter } from '@angular/core';

@Injectable()
export class SearchResultService {

  static choosedBookObjectEmitter = new EventEmitter<any>();
  ...
  bookSelected(bookId: string) {
    this.result.forEach(element => {
      if (element.id === bookId) {
        SearchResultService.bookSelected = element;
        return;
      }
    });
  }
...
result: any[] = [
    JSON.parse(this.jsonBookString)
];
